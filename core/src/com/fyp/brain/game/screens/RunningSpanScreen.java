...
public class RunningSpanScreen implements Screen {
    ...
    public void show() {
        ...
        one.setPosition(Gdx.graphics.getWidth()/2  - 350.0f,Gdx.graphics.getHeight()/2 - 550.0f);
        ...
        two.setPosition(Gdx.graphics.getWidth()/2 - 350.0f,Gdx.graphics.getHeight()/2 - 350.0f);
        ...
        three.setPosition(Gdx.graphics.getWidth()/2 - 350.0f,Gdx.graphics.getHeight()/2 - 150.0f);
        ...
        four.setPosition(Gdx.graphics.getWidth()/2 - 350.0f,Gdx.graphics.getHeight()/2 + 50.0f);
        ...
        five.setPosition(Gdx.graphics.getWidth()/2 - 350.0f,Gdx.graphics.getHeight()/2 + 200.0f);
        ...
        six.setPosition(Gdx.graphics.getWidth()/2 + 50.0f,Gdx.graphics.getHeight()/2 + 50.0f);
        ...
        seven.setPosition(Gdx.graphics.getWidth()/2 + 50.0f,Gdx.graphics.getHeight()/2 - 100.0f);
        ...
        eight.setPosition(Gdx.graphics.getWidth()/2 + 50.0f,Gdx.graphics.getHeight()/2 - 250.0f);
        ...
        nine.setPosition(Gdx.graphics.getWidth()/2 + 50.0f,Gdx.graphics.getHeight()/2 - 550.0f);
        ...
        zero.setPosition(Gdx.graphics.getWidth()/2 + 50.0f,Gdx.graphics.getHeight()/2 - 400.0f);
