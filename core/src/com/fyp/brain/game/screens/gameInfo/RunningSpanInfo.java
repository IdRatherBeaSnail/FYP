...
import com.fyp.brain.game.screens.tutorial.DigitSpanTutorial;

public class RunningSpanInfo implements Screen {
    ...
    public RunningSpanInfo(MyGdxGame game) {
        this.game = game;
        font = new BitmapFont(Gdx.files.internal("fonty.fnt"));
        background = new Texture("digitspanGameSelect.png");
    ...
    public void show () {
        ...
        two.addListener(new ClickListener() {
            @Override
            public void clicked(InputEvent event, float x, float y) {
                game.setScreen(new DigitSpanTutorial(game));
            }
