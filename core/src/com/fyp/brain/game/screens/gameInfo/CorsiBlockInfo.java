...
import com.fyp.brain.game.screens.gameScreens.CorsiBlockScreen;
import com.fyp.brain.game.screens.GameSelect;
import com.fyp.brain.game.screens.tutorial.CorsiTutorial;

public class CorsiBlockInfo implements Screen {
    ...
    public CorsiBlockInfo(MyGdxGame game) {
        this.game = game;
        font = new BitmapFont(Gdx.files.internal("fonty.fnt"));
        background = new Texture("corsiGameSelect.png");
    ...
    public void show () {
        ...
        two.addListener(new ClickListener() {
            @Override
            public void clicked(InputEvent event, float x, float y) {
                game.setScreen(new CorsiTutorial(game));
            }
