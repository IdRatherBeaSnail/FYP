...
import com.fyp.brain.game.screens.gameScreens.StroopScreen;
import com.fyp.brain.game.screens.tutorial.StroopTutorial;

public class StroopInfo implements Screen {
    ...
    public StroopInfo(MyGdxGame game) {
        this.game = game;
        font = new BitmapFont(Gdx.files.internal("fonty.fnt"));
        background = new Texture("stroopGameSelect.png");
    ...
    public void show () {
        ...
        two.addListener(new ClickListener() {
            @Override
            public void clicked(InputEvent event, float x, float y) {
                game.setScreen(new StroopTutorial(game));
            }
