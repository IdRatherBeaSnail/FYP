...
import com.fyp.brain.game.screens.tutorial.NbackTutorial;

public class nbackInfo implements Screen {
    ...
    public nbackInfo(MyGdxGame game) {
        this.game = game;
        font = new BitmapFont(Gdx.files.internal("fonty.fnt"));
        background = new Texture("nBackGameSelect.png");
    ...
    public void show () {
        ...
        two.addListener(new ClickListener() {
            @Override
            public void clicked(InputEvent event, float x, float y) {
                game.setScreen(new NbackTutorial(game));
            }
