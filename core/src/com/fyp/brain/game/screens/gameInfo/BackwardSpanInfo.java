...
import com.fyp.brain.game.screens.gameScreens.BackwardSpanScreen;
import com.fyp.brain.game.screens.GameSelect;
import com.fyp.brain.game.screens.gameScreens.RunningSpanScreen;
import com.fyp.brain.game.screens.tutorial.BackSpanTutorial;

public class BackwardSpanInfo implements Screen {
    ...
    public BackwardSpanInfo(MyGdxGame game) {
        this.game = game;
        font = new BitmapFont(Gdx.files.internal("fonty.fnt"));
        background = new Texture("backspanGameSelect.png");
        ...
        two.addListener(new ClickListener() {
            @Override
            public void clicked(InputEvent event, float x, float y) {
                game.setScreen(new BackSpanTutorial(game));
            }
