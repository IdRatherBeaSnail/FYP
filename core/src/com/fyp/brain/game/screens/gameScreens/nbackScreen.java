...
public class nbackScreen implements Screen {
    ...
    private String easy = "a,o,u,l,e";
    private String[] letters;
    private ArrayList<String> letterList;
    private boolean start;
    private float timer,deltaTime,countdownTimer,timer2;
    ...
    public void show() {
        ...
        for(int i=0; i<N+1; i++){
            letterList.add(letters[randomInt()]);
        }
        ...
        correct.addListener(new ClickListener() {
            @Override
            public void clicked (InputEvent event, float x, float y){
                if(letterList.get(counter).equals(letterList.get(counter-N))){
                    counter++;
                    letterList.add(letters[randomInt()]);
                    player.setScore(1);
                ...
                } else if (!letterList.get(counter).equals(letterList.get(counter-N))){
                    counter ++;
                    letterList.add(letters[randomInt()]);
                    player.loseLife(1);
        ...
        wrong.addListener(new ClickListener() {
            @Override
            public void clicked (InputEvent event, float x, float y){
                if(counter < N || !letterList.get(counter).equals(letterList.get(counter-N))){
                    counter++;
                    letterList.add(letters[randomInt()]);
                    player.setScore(1);
    ...
    public void render(float delta) {
        ...
        if(timer2 <= 3 && timer2 > 2 ){
            ...
            character.setText(letterList.get(counter));
    ...
    private int randomInt(){
        ...
        int randInt = Math.abs(rand.nextInt()) % 5;
        return randInt;
    }
