...
public class StroopTutorial implements Screen {
    ...
    private Texture background,background2,background3,background4;
    private Camera camera;
    private Viewport viewport;
    private Batch batch;
    private int count;

    public StroopTutorial(MyGdxGame game){
        this.game = game;
        font = new BitmapFont(Gdx.files.internal("fonty.fnt"));
        background = new Texture("tutorial/stroop1.png");
        background2 = new Texture("tutorial/stroop2.png");
        background3 = new Texture("tutorial/stroop3.png");
        background4 = new Texture("tutorial/stroop4.png");
