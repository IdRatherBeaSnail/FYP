...
public class BackSpanTutorial implements Screen {
    ...
    public BackSpanTutorial(MyGdxGame game){
        this.game = game;
        font = new BitmapFont(Gdx.files.internal("fonty.fnt"));
        background = new Texture("tutorial/back1.png");
        background2 = new Texture("tutorial/back2.png");
