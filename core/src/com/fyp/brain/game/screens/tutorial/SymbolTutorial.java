...
public class SymbolTutorial implements Screen {
    ...
    public SymbolTutorial(MyGdxGame game){
        this.game = game;
        font = new BitmapFont(Gdx.files.internal("fonty.fnt"));
        background = new Texture("tutorial/symbol1.png");
        background2 = new Texture("tutorial/symbol2.png");
