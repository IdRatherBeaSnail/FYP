...
public class DigitSpanTutorial implements Screen {
    ...
    public DigitSpanTutorial(MyGdxGame game){
        this.game = game;
        font = new BitmapFont(Gdx.files.internal("fonty.fnt"));
        background = new Texture("tutorial/digit1.png");
        background2 = new Texture("tutorial/digit2.png");
